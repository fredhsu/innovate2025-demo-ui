    ...
    content = Div(
        *[
            Card(
                ...
                cls="card flex flex-col h-full max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 text-gray-700",
            )
            for svi in svis
        ],
        id="svi-list",
        cls="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 w-full",
    )
